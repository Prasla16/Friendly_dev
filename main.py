...
def WishOnStartup():
    ...
    if hour>=0 and hour<12:
        print("Hello AP, Good Morning")
        speak("Hello AP, Good Morning")
    elif hour>=12 and hour<18:
        print("Hello AP, Good Afternoon")
        speak("Hello AP, Good Afternoon")
    else:
        print("Hello AP, Good Evening")
        speak("Hello AP, Good Evening")
...
if __name__=='__main__':
    ...
    while True:
        ...
        if 'open wiki' in statement:
            ...
            speak("I was built by AP")
            print("I was built by AP")
